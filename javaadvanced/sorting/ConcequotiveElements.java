 ...
 */
public class ConcequotiveElements {
    public static void main(String[] args) {
        ...
        System.out.println(getConcequotiveElement(A));
    }

    public static int getConcequotiveElement(int[] A){
        long sum=0;
        long min=Integer.MAX_VALUE, n=A.length;
         ...
         * n/2*(2a+(n-1)*d)/2
         * a=start term
         * d=diff between two terms
         * n=length of the array
         */
        long expectedSum=(n*((2*min)+(n-1)*1))/2;
